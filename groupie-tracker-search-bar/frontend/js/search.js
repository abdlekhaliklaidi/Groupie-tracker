function filterArtists() {
  ...
  const artists = document.querySelectorAll(".link");
  console.log(artists);
  ...
  for (let i = 0; i < artists.length; i++) {
    ...
    const creationDate =
      artist.getElementsByClassName("creationDate")[0].textContent;
    const firstAlbumDate =
      artist.getElementsByClassName("firstAlbum")[0].textContent;
